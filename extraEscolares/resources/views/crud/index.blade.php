...
@section('contenido')
    ...
    <a href="/crud/create" class=" btn btn-primary"><i class="icocod">&#10133;</i> Agregar alumno</a>
    <div class="card mt-4">
        <div class="card-body">
            <table id="tabla" class="display nowrap border border-dark mt-2" style="width:100%" >
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> 
                            <a href="{{ route('datos_A', $item->id) }}" class="btn btn-success"> <i class="icocod">&#128194;</i> Subir archivos</a>
                        </td>
                        <td>
